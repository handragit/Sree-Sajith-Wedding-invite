...
export const metadata: Metadata = {
  metadataBase: new URL(wedding.canonicalUrl),
  title: wedding.social.title,
  description: wedding.social.description,
  alternates: { canonical: "/" },
  openGraph: { title: wedding.social.title, description: wedding.social.description, url: "/", siteName: wedding.couple.display, type: "website", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "S & S — 14 December 2026" }] },
...
const eventJsonLd = {
  "@context": "https://schema.org", "@type": "Event", name: "Sree & Sajith — Main Reception",
