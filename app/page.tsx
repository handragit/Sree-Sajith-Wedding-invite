...
export default function Page() {
  return <>
    ...
    <main id="main">
      ...
      <section id="registry" className="registry-section section"><div className="registry-inner"><div className="registry-kolam" aria-hidden="true" /><h2>Registry</h2><p className="registry-lead">Your presence and well wishes are more than enough.</p><p className="registry-copy">Gifts are not expected. If you genuinely wish to give something, this registry will offer a simple way to help reduce duplicate gifting and unnecessary waste, in keeping with the near-zero-waste philosophy of our wedding.</p><div className="registry-rule" aria-hidden="true" /><div className="registry-item"><MajesticonGift size={34} /><h3>Wishlist</h3><span>Coming soon</span></div></div></section>
