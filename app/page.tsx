...
export default function Page() {
  return <>
    ...
    <nav className="nav" aria-label="Main navigation"><a className="monogram" href="#home" aria-label="Sajith and Sreelakshmi, home">{wedding.couple.monogram}</a><div className="nav-links">{[["Events", "events"], ["RSVP", "rsvp"]].map(([label, id]) => <a key={id} href={`#${id}`}>{label}</a>)}</div></nav>
    <main id="main">
